...
const main = async () => {
  ...
  const yourContract = await deploy("SpindleContract"); // <-- add in constructor args like line 19 vvvv
  ...
  */
  ...
  const yourContract = await deploy("SpindleContract", [], {
