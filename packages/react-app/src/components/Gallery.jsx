    ...
    return (
      <div className="product body">
        ...
        <div id="setup" className="main">
          <div className="frame">
            <header className="spindle-header">
              <h1 className="spindle-header__title">
                <a href="./index.html">
                  <img src={Logo} />
                </a>
              </h1>
              <div className="spindle-links">
                <Link className="github" to="/">
                  Home
                </Link>
                <Link className="github" to="create">
                  Create
                </Link>
              </div>
            </header>
          ...
          <div className="slideshow">
            <a href="./product.html" className="slideshow__deco">
              <h1>Title</h1>
              <h3>Description</h3>
            </a>
